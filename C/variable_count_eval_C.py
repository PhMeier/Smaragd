...
import random
import pickle
from A.eval_helper import filter_variable_count
...
def eval(gold_align, pred_align, amr1, amr2, study_bool, make_baseline):
    ...
    if study_bool:
        ...
        test_source = read_file_per_line("c_test.src")
...
if __name__ == "__main__":
    ...
    # variable count eval
    index = filter_variable_count(first_a, second_b, 25)



    path = "C:/Users/phMei/PycharmProjects/AMR_ablation/C"
    test_source = read_file_per_line("c_test.src")
    gold_align = read_file_per_line("c_test.tgt")
    pred_align = read_file_per_line("00026000.hyps.test")
