...
def randomize_and_split(x, y):
    ...
    train = comb[:len(comb) - 5000]
    test_set = comb[len(comb) - 5000:len(comb) - 3500]  # [int(len(comb)*0.7):int(len(comb)*0.8)]
...
if __name__ == "__main__":
    ...
    write_to_file("c_train.src", "c_train.tgt", train)
    write_to_file("c_dev.src", "c_dev.tgt", dev)
    write_to_file("c_test.src", "c_test.tgt", test)
